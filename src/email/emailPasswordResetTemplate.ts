  ...
  <html>
    <body style="font-family: Arial, sans-serif; color: #333;">
      <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <h2 style="color: #635FC7;">Hello ${user.firstName},</h2>
        ...
        <a href="${link}" style="display: inline-block;margin-top: 12px; margin-bottom: 12px;padding: 10px 20px; margin-top: 12px ;background-color: #635FC7; color: #fff; text-decoration: none; border-radius: 5px;">Reset Password</a>
...
export default emailPasswordResetTemplate;
